...
<html lang="pt-br">
 ...
 <h1>PADRÕES DE QUARTOS</h1>

  <br><br>

    <div class="card mb-4 ml-5" style="max-width: 850px; border-width: 3px; border-color: yellow;">
      <div class="row g-0">
        <div class="col-md-4">
          <img src="https://source.unsplash.com/400x300/?homes" class="img-fluid rounded-start" alt="...">
        </div>
        <div class="col-md-8">
          <div class="card-body">
            ...
            <a href="#" class="btn btn-outline-warning">Reserve-já</a>
          </div>
        </div>
      </div>
    </div>
   ...
   <div class="card mb-4 ml-5 text-align: center;" style="max-width: 850px; border-width: 3px; border-color: yellow;">
      <div class="row g-0">
        <div class="col-md-4">
          <img src="https://source.unsplash.com/400x300/?homes" class="img-fluid rounded-start" alt="...">
        </div>
        <div class="col-md-8">
          <div class="card-body">
            <h5 class="card-title">QUARTO MASTER</h5>
   ...
   <div class="card mb-4 ml-5" style="max-width: 850px; border-width: 3px; border-color: yellow;">
      <div class="row g-0">
        ...
        <div class="col-md-8">
          <div class="card-body">
            <h5 class="card-title">QUARTO DELUX</h5>
            <p class="card-text">Acomodações com separação de ambientes, possui a melhor vista do hotel, este quarto contém uma grande cama de casal, no seu banheiro há uma banheira e hidro massagem (cabem até duas pessoas).</p>
            <a href="#" class="btn btn-outline-warning">Reserve-já</a>
          </div>
        </div>
      </div>
